    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='boards.topic')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(related_name='interested_reader', to='boards.Interests')),
            ],
        ),
        migrations.CreateModel(
            name='Blogger',
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='categories_reader', to='boards.Categories')),
            ],
        ),
    ]
